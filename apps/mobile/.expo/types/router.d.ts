...
declare module 'expo-router' {
  export namespace ExpoRouter {
    export interface __routes<T extends string = string> extends Record<string, unknown> {
      StaticRoutes: `/` | `/(tabs)` | `/(tabs)/` | `/(tabs)/discover` | `/(tabs)/my-appointments` | `/_sitemap` | `/book/[slug]/` | `/book/[slug]/confirmation` | `/book/[slug]/datetime` | `/book/[slug]/details` | `/book/[slug]/otp` | `/book/[slug]/staff` | `/discover` | `/my-appointments` | `/my-salons`;
