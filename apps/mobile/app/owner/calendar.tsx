      ...
      <View style={[styles.apptCard, { borderStartColor: sc }]}>
        ...
        {appt.staff ? (
          <View style={styles.staffRow}>
            ...
            <Text style={styles.staffText}>{appt.staff.display_name}</Text>
          </View>
        ) : null}
        <View style={styles.durationRow}>
          <Icon name="time-outline" size={12} color={colors.mutedForeground} />
          <Text style={styles.durationText}>{appt.service.duration_mins} {t('minutes')}</Text>
        </View>
      </View>
    </View>
  );
...
export default function OwnerCalendarScreen() {
  ...
  // Build full-day range in ISO format
    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          ...
          <Text style={styles.headerSub}>{salon?.name ?? t('loading')}</Text>
        </View>
      </View>
