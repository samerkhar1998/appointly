...
// Renders a single service row with price badge and details.
    ...
    <View style={[styles.serviceRow, !service.is_active && styles.serviceRowInactive]}>
      ...
      <View style={styles.serviceInfo}>
        <View style={styles.serviceTop}>
          <Text
            style={[styles.serviceName, !service.is_active && styles.serviceNameInactive]}
            numberOfLines={1}
          >
            {service.name}
          </Text>
...
function SkeletonRow() {
  return (
    <View style={styles.serviceRow}>
      <View style={[styles.priceBadge, styles.skeleton, { width: 52, height: 72 }]} />
      <View style={styles.serviceInfo}>
...
// Owner Services tab — grouped list of all salon services.
// Fetches the owner's salon then loads the service list grouped by category.
export default function OwnerServicesTab() {
  ...
  // Group services by category name for sectioned display.
...
const styles = StyleSheet.create({
  ...
  content: { paddingHorizontal: spacing[4], paddingTop: spacing[4], gap: spacing[5] },
  group: { gap: spacing[2] },
  groupLabel: {
  ...
  serviceInfo: { flex: 1, padding: spacing[3], gap: spacing[0.5] },
  serviceTop: { flexDirection: 'row-reverse', alignItems: 'center', gap: spacing[2] },
  serviceName: {
    fontFamily: 'Heebo_600SemiBold',
  ...
  inactiveBadgeText: { fontFamily: 'Heebo_400Regular', fontSize: 10, color: colors.muted },
  serviceDesc: {
    fontFamily: 'Heebo_400Regular',
    fontSize: fontSize.xs,
    color: colors.muted,
  ...
  durationText: { fontFamily: 'Heebo_400Regular', fontSize: 10, color: colors.mutedForeground },
  dot: { width: 3, height: 3, borderRadius: 2, backgroundColor: colors.mutedForeground },
  categoryText: { fontFamily: 'Heebo_400Regular', fontSize: 10, color: colors.mutedForeground },
